...
<div class="card">
    <div class="card-header text-center">
        <strong>Editar Estado de Ficha</strong>
    </div>
    <div class="card-body">
        @include('flash::message')
        <form id="form" action="/estadoFicha/actualizar/{{$estadoFicha->id}}" method="post">
            @csrf
            <input type="hidden" name="id" value="{{$estadoFicha->id}}" />
            <div class="row">
                <div class="col-md-3 col-sm-12">
                    <div class="form-group">
                        <label for="">Id<b style="color: red" data-toggle="tooltip" data-placement="top"
                                title="Requerido"> *</b></label>
                        <input type="text" class="form-control" value="{{$estadoFicha->id}}" readonly />
                    </div>
                </div>
                <div class="col-md-9 col-sm-12">
                    <div class="form-group">
                        <label for="descripcion">Descripción<b style="color: red" data-toggle="tooltip" data-placement="top"
                                title="Requerido"> *</b></label>
                        <input value="{{$estadoFicha->descripcion}}" type="text"
                ...
                <div class="col-12 d-flex justify-content-between align-items-center">
                    <a href="/estadoFicha" class="btn btn-primary tipoletra">Volver</a>
