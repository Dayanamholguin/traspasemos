...
<div class="card">
    <div class="card-header text-center">
        <strong>Crear Estado de Ficha</strong>
    </div>
    <div class="card-body">
        @include('flash::message')
        <form id="form" action="/estadoFicha/guardar" method="post">
            @csrf
            <div class="row">
                <div class="col-md-3 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$estadoFicha==null?"1":($estadoFicha->id+1)}}" readonly />
                    </div>
                </div>
