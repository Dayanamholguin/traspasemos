                                ...
                                <div class="p-5">
                                    ...
                                    <form method="POST" class="user" action="{{ route('password.confirm') }}">
                                        ...
                                        <div class="form-group">
                                            <input id="password" type="password" class="form-control form-control-user @error('password') is-invalid @enderror" aria-describedby="emailHelp" placeholder="Contraseña"  name="password" required autocomplete="current-password">
                                            @error('password')
