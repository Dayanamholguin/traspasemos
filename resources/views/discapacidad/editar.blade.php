...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form id="form" action="/discapacidad/actualizar/{{$discapacidad->id}}" method="post">
            @csrf
            ...
            <div class="row">
                <div class="col-md-3 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$discapacidad->id}}" readonly />
                    </div>
                </div>
                <div class="col-md-9 col-sm-12">
                    <div class="form-group">
                        <label for="descripcion">Descripción<b style="color: red" data-toggle="tooltip" data-placement="top"
                                title="Requerido"> *</b></label>
                        <input value="{{$discapacidad->descripcion}}" type="text"
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="form-group">
                        <label for="link">Link<b style="color: red" data-toggle="tooltip" data-placement="top"
                                title="Requerido"> *</b></label>
                        <input value="{{$discapacidad->link}}" type="text"
