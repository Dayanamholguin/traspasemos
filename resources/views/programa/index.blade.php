...
<div class="card">
    <div class="card-header">
        ...
        <a href="/programa/crear" class="alert-link btn btn-primary tipoletra"><i class="bi bi-person-plus"></i> Crear Programa</a>
        
    </div>
    <div class="card-body">
    @include('flash::message')
    
        <table id="programa" class="table table-bordered dt-responsive dataTable text-left" style="width: 100%;">
            <thead>
                <tr>
                    <th>Descripción</th>
                    <th>Estado</th>
...
{{-- Modal --}}
<div class="modal fade" id="verprogramaModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
