...
<div class="card">
    <div class="card-header text-center">
        <strong>Crear NEE</strong>
    </div>
    <div class="card-body mb-3">
        @include('flash::message')
        <form id="form" action="/nee/guardar" method="post">
            @csrf
            <div class="row">
                <div class="col-md-3 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$nee==null?"1":($nee->id+1)}}" readonly />
                    </div>
                </div>
                <div class="col-md-9 col-sm-12">
                    <div class="form-group">
                        ...
                        <input id="nombre" type="text" name="nombre" value="{{ old('nombre') }}"
                            ...
                            autocomplete="nombre" placeholder="Ingrese su descripción" />
                        @error('nombre')
